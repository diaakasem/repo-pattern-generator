...
import {
    ConsoleManager, OptionPopup, InputPopup,
    PageBuilder, ButtonPopup, ConfirmPopup ,
    FileSelectorPopup, CustomPopup
...
const updateConsole = async() => {
    ...
    p.addRow({ text: "Commands:", color: 'white' })
...
//     const max = 1000;
//     let period = 1000;
//     const _mode = "Cool Mode";
//     const modeList = ["Cool Mode", "Hot Mode", "Warm Mode"];
//     let mode = "Cool Mode";
//     const connectedClients = 0;
//     const tcpCounter = 0;
//     const _min = 0;
